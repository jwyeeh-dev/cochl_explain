...
def main():
    ...
    if model_type == 'ensemble':
        grad_cam_results1, grad_cam_results2 = GradCAMUtils.generate_grad_cam_tf_explain(inner_model_0, inner_model_1, model_pre_output, class_index, ['m_main_0_Conv1', 'm_main_1_Conv1'], args)
    else:
        grad_cam_results1, grad_cam_results2 = GradCAMUtils.generate_grad_cam_tf_explain(model_main, model_pre_output, class_index, 'conv_46', args)
